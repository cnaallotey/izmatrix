...
<template>
  <div
    class="w-full bg-[url('https://images.unsplash.com/photo-1591955506264-3f5a6834570a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80')] bg-cover bg-center "
  >
    <div class="w-full px-3 antialiased bg-gradient-to-br from-gray-900/80 via-black/80 to-gray-800/80 lg:px-6 pt-5">
      <div class="mx-auto max-w-screen-xl ">
        
          <nav class="flex items-center w-full h-fit md:h-20 select-none bg-black/50 backdrop-blur-lg px-4 rounded-full">
        <div
        ...
        >
          ...
          >
            ...
            >
              <svg
                class="w-auto h-5 -translate-y-px"
                viewBox="0 0 69 66"
                fill="none"
          ...
          <div
            ...
            class="absolute z-50 flex-col items-center justify-center w-full h-auto px-2 text-center text-gray-400 -translate-x-1/2 border-0 border-gray-700 rounded-none md:border-b md:w-auto md:h-10 left-1/2 md:flex-row md:items-center"
          >
            <a
              href="#"
          ...
          <div class="md:flex gap-6 hidden">
            <div
            class="flex items-center justify-center md:justify-start w-full md:w-fit gap-4"
          >
            <a
              ...
              :href="social.url"
              target="_blank"
              class="text-white p-3 rounded-full bg-white/20 hover:text-orange-500"
            >
              <Icon :name="social.icon" class="w-6 h-auto" /><span class="sr-only">{{
                social.name
              }}</span>
            </a>
          </div>
          ...
          <div
            class="fixed top-0 left-0 z-40 items-center hidden w-full h-full p-3 text-sm bg-gray-900 bg-opacity-50 md:w-auto md:bg-transparent md:p-0 md:relative"
          ...
          <div
            ...
            class="absolute right-0 z-50 flex flex-col items-end translate-y-[10px] w-10 h-10 p-2 mr-4 rounded-full cursor-pointer md:hidden hover:bg-gray-200/10 hover:bg-opacity-10"
      ...
      <div class="container px-6 py-52 mx-auto md:text-center md:px-4">
        <h1
        ...
        >
          ...
          <span class="relative inline-block mt-3 text-white">design websites</span>
        </h1>
        <p
        ...
        >
          If you are ready to change the way you design websites, then you'll want to use
          our block builder to make it fun and easy!
        </p>
